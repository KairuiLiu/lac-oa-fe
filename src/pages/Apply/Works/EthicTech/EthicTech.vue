			...
			<a-form ref="formRef" name="custom-validation" :label-col="{ style: { width: '120px' } }" label-align="left" :model="state.formState">
				...
				<a-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32 }" type="flex">
					<a-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
						<a-form-item :name="['base', 'department']" :rules="ruleNN" label="院系（单位）"><a-input v-model:value="state.formState.base.department" /></a-form-item>
					</a-col>
					<a-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12"
						><a-form-item :name="['base', 'tel']" :rules="[{ required: true, validator: validateTel, message: '电话有误' }]" label="电话">
							<a-input v-model:value="state.formState.base.tel" /> </a-form-item
					></a-col>
					<a-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12"
						><a-form-item :name="['base', 'major']" :rules="ruleNN" label="专业"> <a-input v-model:value="state.formState.base.major" /> </a-form-item
					></a-col>
					<a-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12"
						><a-form-item :name="['base', 'class']" :rules="ruleNN" label="年级/班级"> <a-input v-model:value="state.formState.base.class" /> </a-form-item
					></a-col>
					<a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24"
						><a-form-item :name="['base', 'study']" :rules="ruleNN" label="教学课程名称"> <a-input v-model:value="state.formState.base.study" /> </a-form-item
					></a-col>
					<a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24"
					...
					></a-col>
					<a-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12"
						><a-form-item :name="['base', 'source']" :rules="ruleNN" label="动物来源"> <a-input v-model:value="state.formState.base.source" /> </a-form-item
					></a-col>
					<a-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12"
							...
							<a-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32 }">
								...
								<a-col :span="8">
									<a-form-item :name="['base', 'aniQF']" :rules="ruleNNP">
										<a-input v-model:value.number="state.formState.base.aniQF" prefix="♀" suffix="只" />
									</a-form-item>
								</a-col>
								<a-col :span="8">
									<a-form-item :name="['base', 'aniQM']" :rules="ruleNNP">
										<a-input v-model:value.number="state.formState.base.aniQM" prefix="♂" suffix="只" />
									</a-form-item>
								</a-col>
							</a-row> </a-form-item
					></a-col>
					<a-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8"
						><a-form-item :rules="ruleNN" :name="['base', 'directorName']" label="实验负责人姓名"> <a-input v-model:value="state.formState.base.directorName" /> </a-form-item></a-col
					><a-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8"
						><a-form-item :rules="[{ required: true, validator: validateTel, message: '电话有误' }]" label="移动电话" :name="['base', 'directorTel']">
							<a-input v-model:value="state.formState.base.directorTel" type="tel" /> </a-form-item></a-col
					><a-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8"
						><a-form-item :rules="[{ required: true, validator: validateEmail, message: '邮箱有误' }]" :name="['base', 'directorEmail']" label="邮箱E-mail">
							<a-input v-model:value="state.formState.base.directorEmail" /> </a-form-item
					></a-col>
				</a-row>
				...
				<a-row type="flex" justify="end">
					<a-col :span="23">
						<a-form-item :name="['overview']" :rules="ruleNN">
							<a-textarea v-model:value="state.formState.overview" allow-clear :rows="7" />
						</a-form-item>
					</a-col>
				</a-row>
				<a-row type="flex" justify="end">
...
import { defineComponent, defineExpose, reactive, onBeforeMount, ref } from 'vue';
